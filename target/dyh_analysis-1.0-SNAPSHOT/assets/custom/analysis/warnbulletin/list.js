...
var vue = new Vue({
    ...
    data: {
        ...
        urls: {
            //最新时间
            queryNewDateUrl: ctx + '/analysis/warnbulletin/getNewestDate.vm',
            // 列表数据
            queryReportListByAscriptionType: ctx + '/analysis/warnbulletin/queryReportListByAscriptionType.vm',
            //查看页面
            viewUrl: ctx + '/analysis/warnbulletin/index.vm',
            // 编辑页面
            editUrl: ctx + '/analysis/warnbulletin/add.vm',
            //提交
    ...
    methods: {
        ...
        toAdd: function (reportId) {
            let url = this.urls.editUrl + '?reportId=' + reportId + '&ascriptionType=' + this.param.ascriptionType + '&menuName=' + this.menuName;
        ...
        submit: function (reportId) {
            let _this = this;
            DialogUtil.showConfirmDialog("确认提交？", function () {
                // 当前选中
                AjaxUtil.sendAjaxRequest(_this.urls.submitUrl, 'post', {
                    reportId: reportId
                }, function (json) {
