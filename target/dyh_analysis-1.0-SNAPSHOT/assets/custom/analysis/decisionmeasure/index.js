...
var vue = new Vue({
    ...
    data: {
        ...
        urls: {
            // 根据归属类型最新文件信息
            queryFileInfo: ctx + '/analysis/decisionMeasure/getFileInfoByAscriptionType.vm',
            //列表页面
            listUrl: ctx + '/analysis/decisionMeasure/list.vm',
            // 查询文件是否存在
            ...
            // 修改报告状态
            updateReportState: ctx + '/analysis/forecastflow/specialforecast/specialForecast/updateReportState.vm'
        },
        // 菜单名称
        menuName:menuName,
        // 归属类型
    ...
    methods: {
         ...
         */
        goList:function (){
            let url=this.urls.listUrl +'?ascriptionType='+this.ascriptionType+'&menuName='+this.menuName+'&isShowControl='+this.isShowControl;
