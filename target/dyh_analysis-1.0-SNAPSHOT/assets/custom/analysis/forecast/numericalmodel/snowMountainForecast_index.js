let vue = new Vue({
    ...
    methods: {
        ...
        initEchartsAqi: function () {
            ...
            let legendData = ['00时'];
            if (_this.queryParams.model != 'CFS' && _this.queryParams.model != 'CMA' && _this.queryParams.model != 'GFS_NEWSNOW'){
                legendData =['00时', '12时'];
            }
            let option = {
                tooltip: {
        ...
        drawWeatherChart(option_12, option_00) {
            ...
            // 为echarts对象加载数据
            if (this.queryParams.model != 'CFS' && _this.queryParams.model != 'CMA' && _this.queryParams.model !='GFS_NEWSNOW'){
