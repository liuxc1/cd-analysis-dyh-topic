...
var vue = new Vue({
    ...
    data: {
        ...
        urls: {
            ...
            // 根据归属类型查询最大月份
            queryMaxMonthByAscriptionTypeUrl: ctx + '/analysis/express/newsletterAnalysis/queryMaxMonthByAscriptionType.vm',
            // 根据月份，查询频率为日的时间轴列表（月份 可为空）
            queryForecastListByMonthUrl: ctx + '/analysis/express/newsletterAnalysis/queryForecastListByMonth.vm',
            // 添加页面
            addUrl: ctx + '/analysis/express/newsletterAnalysis/expressEdit.vm',
            // 编辑页面
            editUrl: ctx + '/analysis/express/newsletterAnalysis/expressEdit.vm',
            // 删除
            deleteReportById: ctx + '/analysis/express/newsletterAnalysis/deleteReportById.vm',
            // 查询文件是否存在
            queryFile: ctx + '/system/file/file/queryFile.vm',
            // pdf查看页面
            viewer: ctx + '/assets/components/pdfjs-2.0.943-dist/web/viewer.html',
            // 报告是否有提交记录
            queryStateNumber: ctx + '/analysis/express/newsletterAnalysis/queryStateNumber.vm',
            // 修改报告状态
    ...
    methods: {
        ...
        timeAxisListClick: function (data) {
            var _this = this;
            AjaxUtil.sendAjaxRequest(_this.urls.queryForecastListByMonthUrl, null, {
                ascriptionType: _this.ascriptionType,
                startMonth: _this.startMonth,
        ...
        goEdit: function () {
            ...
            this.pageDialog = DialogUtil.showFullScreenDialog(this.urls.editUrl + '?reportId=' + reportId);
            $('body').css('overflow-y', 'hidden');
        },
        /**
         * 删除数据
