...
<head>
    ...
    <link href="${ctx}/assets/components/element-ui/css/index.css?v=20221129015223" rel="stylesheet" type="text/css">
    <style type="text/css">
        .option-type {
            width: 90px;
            height: 50px;
...
<script src="${ctx}/assets/custom/analysis/airqualitystatus/index.js?v=20221129015223"></script>
</body>
</html>