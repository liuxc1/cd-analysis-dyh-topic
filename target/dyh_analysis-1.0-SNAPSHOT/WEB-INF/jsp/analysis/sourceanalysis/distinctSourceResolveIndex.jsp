...
<link href="${ctx}/assets/components/viewer-master/dist/viewer.min.css?v=20221129015223" rel="stylesheet">
<style type="text/css">
    .no-data {
    	font-size: 16px;
    }
...
<body class="no-skin" >
	...
	<!-- 图片点击放大插件 -->
	<!-- 分析平台-文件上传表格组件-逻辑js -->
	<script type="text/javascript" src="${ctx}/assets/components/viewer-master/dist/viewer.min.js?v=20221129015223"></script>	<!-- Dialog 工具类 -->
	...
	<!-- 自定义js（逻辑js） -->
	<script src="${ctx}/assets/js/echart-ct.js?v=20221129015223" type="text/javascript"></script>
	<script type="text/javascript" src="${ctx}/assets/custom/analysis/sourceAnalysis/distinctSourceResolveIndex.js?v=20221129015223"></script>
</body>
</html>