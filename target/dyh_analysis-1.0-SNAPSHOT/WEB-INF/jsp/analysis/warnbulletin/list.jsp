                        ...
                        <table class="table table-bordered">
                            ...
                            <tr v-for="(item,index) in listObj.list" style="">
                                ...
                                <td style="text-align: center;vertical-align: middle">
                                    ...
                                    <a v-if="item.state !== 'UPLOAD'" @click="submit(item.reportId)">提交</a>
...
<!-- 自定义js（逻辑js） -->
<script type="text/javascript" src="${ctx}/assets/custom/analysis/warnbulletin/list.js?v=20221129015223"></script>
</body>
</html>