    ...
    <div class="main-content-inner fixed-page-header fixed-40">
        <div id="breadcrumbs" class="breadcrumbs">
            <ul class="breadcrumb">
                <li class="active">
                    <h5 class="page-title">
                        <i class="menu-icon fa fa-hand-spock-o"></i>
                        冬季快报分析报告
                    </h5>
                </li>
            </ul>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 no-padding">
                            <div class="col-sm-3 no-padding">
                                ...
                                <div class="col-sm-8 input-group" @click="wdatePicker">
                                    <input type="text" id="wdate-picker" v-model="yearMonth" class="form-control" placeholder="请选择填报月份" readonly>
                        ...
                        <%-- <div class="col-sm-6 align-right">
                             <button type="button" class="btn btn-info btn-default-ths" @click="search">
...
<!-- 自定义js（逻辑js） -->
<script type="text/javascript" src="${ctx}/assets/custom/analysis/analysisreport/winterexpress/winterExpressList.js?v=20221129015223"></script>
</body>
</html>