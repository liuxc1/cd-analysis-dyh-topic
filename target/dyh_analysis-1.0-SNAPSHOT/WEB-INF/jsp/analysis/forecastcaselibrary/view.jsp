...
<link rel="stylesheet" href="${ctx }/assets/custom/analysis/forecastcastlibrary/step_play.css?v=20221129015223">
<link rel="stylesheet" href="${ctx }/assets/custom/analysis/forecastcastlibrary/util-1.0.1.css?v=20221129015223">
...
<body class="no-skin">
	...
	<script src="${ctx}/assets/components/echarts/echarts.js?v=20221129015223"></script>
	<script src="${ctx}/assets/components/element-ui/index.js?v=20221129015223"></script>
	<!-- 分页组件 -->
	<%@ include file="/WEB-INF/jsp/components/common/page-pagination.jsp"%>
	<!-- 自己写的JS，请放在这里 -->
	<script src="${ctx}/assets/custom/analysis/forecastcastlibrary/view.js?v=20221129015223"></script>
</body>
</html>