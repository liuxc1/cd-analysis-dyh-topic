                                    ...
                                    <div class="col-xs-9 radio-group">
                                        <div class="row">
                                            <div class="d" style="withd:300px;float: left;">
                                                <label class="radio-inline">
                                                    <input type="radio" style="margin-top: -2px;" class="isButton radio"
                                                           data-oper="search" name="types" class="d0" id="leix1"
                                            ...
                                            <div class="d" style="withd:300px;float: left;margin-left:50px;">
                                                <label class="radio-inline">
                                                    <input type="radio" style="margin-top: -2px;" class="isButton radio"
                                                           data-oper="search" name="types" class="d0" id="leix2"
                                                           value="DT"/>
                                        ...
                                        <div class="row">
                                            <div class="d" style="withd:300px;float: left;">
                                                <label style="margin-left: 0px;" class="radio-inline">
                                                    <input type="radio" style="margin-top: -2px;" class="isButton radio"
                                                           data-oper="search" name="types" class="d0" id="leix4"
                                                           value="HWF"/>
                                            ...
                                            <div class="d" style="withd:300px;float: left;margin-left:64px;">
                                                <label class="radio-inline">
                                                    <input type="radio" style="margin-top: -2px;" class="isButton radio"
                                                           data-oper="search" name="types" class="d0" id="leix5"
                                                           value="PPH"/>
                                        ...
                                        <div class="row">
                                            <div class="d" style="withd:300px;float: left;">
                                                <label class="radio-inline">
                                                    <input type="radio" style="margin-top: -2px;" class="isButton radio"
                                                           data-oper="search" name="types" class="d0" id="leix3"
                                                           value="HC"/>
...
<script src="${ctx}/assets/custom/analysis/forecast/weatherforecast/wrfmap.js?v=20221129015223"></script>
