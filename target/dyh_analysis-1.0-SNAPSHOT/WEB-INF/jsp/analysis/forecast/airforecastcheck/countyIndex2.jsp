...
<head>
    ...
    <!-- 引入样式 -->
    <%--<link rel="stylesheet"	href="${ctx}/assets/components/element-ui/lib/theme-chalk/index.css?v=20221129015223">--%>
    <!--页面自定义的CSS，请放在这里 -->
</head>
<body class="no-skin">
...
<script type="text/javascript" src="${ctx}/assets/custom/analysis/forecast/airforecastcheck/countyIndex2.js?v=20221129015223"></script>
</body>
</html>