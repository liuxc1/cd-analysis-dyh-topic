...
<body>
								...
								<form class="form-horizontal" role="form" style="margin-top: 8px">
									<div class="form-group">
										...
										<div class="col-xs-4 input-group" style="float:left;">
											<%-- <input type="text" readonly="readonly" id="dateTime" name="dateTime"
				                                filetype="String" class="Wdate w-input form-control"
				                                onFocus="WdatePicker({  el: 'dateTime', dateFmt: 'yyyy-MM-dd',isShowClear:true})"
				                                value="${dateTime}" /> --%>
									...
									<div class="form-group">
										...
										<div class="col-xs-9 radio-group">
											<div class="row">
												...
												<div class="d" style="float: left;margin-left:10px;">
													<label class="radio-inline">
														<input type="radio" style="margin-top: -2px;" class="isButton radio" data-oper="search" name="types" class="d0" id="leix2" value="o3" />
	...
	<script src="${ctx}/assets/custom/analysis/forecast/concentrationdistribution/concentrationdistribution.js?v=20221129015223"></script>
