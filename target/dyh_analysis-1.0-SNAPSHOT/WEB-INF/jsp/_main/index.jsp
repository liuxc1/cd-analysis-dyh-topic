...
<html lang="zh">
	<head>
	    ...
	    <link rel="stylesheet" href="${ctx}/assets/css/common/ths-menu.css?v=20221205102239"/>
	    <link rel="stylesheet" href="${ctx}/assets/custom/common/common/css/ths-menu-new.css?v=20221205102239"/>
	    <!-- ace settings handler -->
	    <script src="${ctx}/assets/js/menu/ace-extra.js?v=20221205102239"></script>
	</head>
	...
	<body class="no-skin body">
		...
		<script type="text/javascript">
		    if ('ontouchstart' in document.documentElement) document.write("<script src='${ctx}/assets/components/jquery.mobile.custom/jquery.mobile.custom.js?v=20221205102239'>" + "<" + "/script>");
		</script>
		<script src="${ctx}/assets/components/bootstrap/dist/js/bootstrap.js?v=20221205102239"></script>
		
		<!-- page specific plugin scripts -->
		<script src="${ctx}/assets/js/ths-util.js?v=20221205102239"></script>
		<!-- ace scripts -->
		<script src="${ctx}/assets/js/menu/elements.scroller.js?v=20221205102239"></script>
		<script src="${ctx}/assets/js/ace.js?v=20221205102239"></script>
		<script src="${ctx}/assets/js/menu/ace.basics.js?v=20221205102239"></script>
		<script src="${ctx}/assets/js/menu/ace.sidebar.js?v=20221205102239"></script>
		<script src="${ctx}/assets/js/menu/ace.sidebar-scroll-1.js?v=20221205102239"></script>
		<script src="${ctx}/assets/js/menu/ace.submenu-hover.js?v=20221205102239"></script>
