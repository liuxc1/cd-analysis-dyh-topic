    ...
    <div class="main-content">
        <div class="main-content-inner fixed-page-header fixed-82">
            ...
            <div class="page-toolbar align-right">
                <button type="button" class="btn btn-xs btn-error btn-xs-ths" data-self-js="exportPdf()" id="btnExport" >
                    <i class="ace-icon fa fa-file-excel-o"></i>
                     导出Pdf
                </button>
                <button type="button" class="btn btn-xs   btn-xs-ths" data-self-js="exportWord()" id="btnExport" >
                    <i class="ace-icon fa fa-file-excel-o"></i>
                     导出Word
                </button>
                        ...
                        <form class="form-horizontal" role="form" id="formInfo" action="" method="post">
                                 ...
                                 <input type="hidden"  id="txtDeptManagerId" name="form['DEPT_MANAGER_ID']"  value="${form.DEPT_MANAGER_ID}"/> 
                                  <input type="hidden"   id="txtDeptManager" name="form['DEPT_MANAGER']"  value="${form.DEPT_MANAGER}"/> 
                                     <div class="chosen-container chosen-container-multi width-100"
                                         style="border: solid 1px #D5D5D5; min-height: 75px ">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input  type="text" id="curUser" class="form-control"  name=""  value=""
                                               readonly="readonly" onclick="selectUser()"/>
                                </div>
                                <label class="col-sm-2 control-label no-padding-right">
                                  选择部门
                                </label>
                                <div class="col-sm-4">
                                     <input  type="text" class="form-control"  name=""  value=""
                                               readonly="readonly" onclick="selectDept()"/>
                                </div>
                             </div>
                        </form>
                    </div>
...
<script type="text/javascript">
	...
	function save(){
		...
		ths.hideNullValidate("formInfo",function(){
			ths.submitFormAjax({
	            url:'profeedoc_save.vm',// any URL you want to submit
	...
	**/
	...
	function removeUser(loginName){
	 ...
	 //导出PDF	
	 function exportPdf(){
		window.location.href = "${ctx}/demo/eform/profee_doc/profeedoc_exportpdf.vm?id=${form.PRO_ID}";
	 }
	...
	jQuery(function($){
		...
		$("#btnChooseDeptManager").on(ace.click_event,function(){
			...
			dialog({
				id:"dialog-user-muti",
	            title: '选择',
	            url: '${ctx}/common/ou/selUserMuti.html?hiddenId=txtDeptManagerId',
	            width:550,
	            height:510>document.documentElement.clientHeight?document.documentElement.clientHeight:510,
	        }).showModal();
		});
