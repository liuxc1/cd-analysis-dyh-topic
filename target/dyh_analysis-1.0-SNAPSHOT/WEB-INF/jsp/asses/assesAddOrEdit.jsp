...
<head>
    ...
    <!-- 引入样式 -->
    <link href="${ctx }/assets/custom/common/vueplus/index.css?v=20221129015223" rel="stylesheet"/>
</head>
<style>
    .self-float-left {
...
<!-- 自定义js（逻辑js） -->
<!-- 引入组件库 -->
<script type="text/javascript" src="${ctx }/assets/custom/common/vueplus/qs.js?v=20221129015223"></script>
...
<script type="text/javascript" src="${ctx }/assets/custom/common/vueplus/xlsx.js?v=20221129015223"></script>

<script type="text/javascript" src="${ctx}/assets/custom/asses/js/afterAssesAddOrEdit.js?v=20221129015223"></script>
</body>
</html>