...
<html lang="zh">
	<head>
	    ...
	    <link rel="stylesheet" href="${ctx}/assets/blue/css/proctree.css?v=20221129015223"/>
	  	<!--页面自定义的CSS，请放在这里 -->
	    <style type="text/css">
	...
	<body class="no-skin">
		                       ...
		                       <div class="col-xs-2 no-padding">
		                           <div class="widget-box transparent">
		                               <div class="widget-header">
		                                   <h5 class="widget-title lighter smaller hidden-sm hidden-xs" style="margin-left: 5px">表单分类</h5>
		                               ...
		                               <div id="divTreeWidget" class="widget-body" style="margin-right: -1px;overflow: auto">
		                                   <div class="widget-main padding-2">
		                                       <iframe id="iframeTree" name="iframeTree" width="100%" frameborder="0"
												 	src="${ctx }/eform/tree/window.vm?sqlpackage=ths.jdp.eform.mapper.settings.category.CategoryMapper&mapperid=tree&callback=treeCallback&loginName=<%=request.getAttribute("loginName") == null || ths.jdp.core.web.LoginCache.isSuperAdmin(request.getAttribute("loginName").toString()) ? "" : request.getAttribute("loginName").toString() %>&jdpAppCode=<%=ths.jdp.core.context.PropertyConfigure.getProperty("jdp.app.code").toString()%>&categoryTypeId=EFORM_DESIGN"></iframe>
		                                   </div>
		                               </div>
		                           </div>
		...
		<script type="text/javascript">
			...
			function redirect(_treeid, _treeName){
				$("#ifrmDef").attr("src", "${ctx }/eform/formdesign/formdesign_main_list.vm?categoryId=" + _treeid + "&categoryName=" + encodeURI(encodeURI(_treeName)));
				$("#ifrmCategory").attr("src", "${ctx }/eform/settings/category/cat_list.vm?treeId=" + _treeid+"&tableName=JDP_EFORM_FORM");
			}
			/*ztree节点变化*/
