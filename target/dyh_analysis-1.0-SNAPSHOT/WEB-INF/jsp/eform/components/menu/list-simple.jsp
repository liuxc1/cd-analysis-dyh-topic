...
<!--[if !IE]> -->
<script src="../components/jquery/dist/jquery.js?v=20221129015223"></script>
<!-- <![endif]-->
...
<script type="text/javascript">
    if ('ontouchstart' in document.documentElement) document.write("<script src='../components/_mod/jquery.mobile.custom/jquery.mobile.custom.js?v=20221129015223'>" + "<" + "/script>");
</script>
<script src="../components/bootstrap/dist/js/bootstrap.js?v=20221129015223"></script>

<!-- page specific plugin scripts -->
<script src="../components/jquery-ui/jquery-ui.js?v=20221129015223"></script>
<script src="../components/jqueryui-touch-punch/jquery.ui.touch-punch.js?v=20221129015223"></script>

<!--ace script-->
<script src="../assets/js/src/ace.js?v=20221129015223"></script>

<!--THS script-->
<script src="../assets/js/ths.js?v=20221129015223"></script>
