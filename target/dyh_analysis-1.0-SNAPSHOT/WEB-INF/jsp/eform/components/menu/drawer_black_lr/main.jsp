...
<head>
	...
	<%@ include file="/WEB-INF/jsp/_common/commonCSS.jsp"%>
	 <link rel="stylesheet" href="${ctx}/assets/js/eform/custom_menu/drawer_black/css/child_menu.css?v=20221129015223"/>
    <link rel="stylesheet" href="${ctx}/assets/js/eform/custom_menu/drawer_black/css/style_lr.css?v=20221129015223"/>
    <!-- 自己写的CSS，请放在这里 -->
    <style type="text/css">
    </style>
    <!-- ace settings handler -->
    <script src="${ctx}/assets/js/menu/ace-extra.js?v=20221129015223"></script>
    <script src="${ctx}/assets/components/jquery-nicescroll/jquery.nicescroll.min.js?v=20221129015223"></script>
    <script src="${ctx}/assets/components/jquery-nicescroll/jquery.nicescroll.plus.js?v=20221129015223"></script>
    <script src="${ctx}/assets/js/eform/custom_menu/drawer_black/js/custom.js?v=20221129015223"></script>
    <script src="${ctx}/assets/js/eform/custom_menu/drawer_black/js/google-maps.js?v=20221129015223"></script>
</head>
