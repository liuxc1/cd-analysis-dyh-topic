                        ...
                        <form class="form-horizontal" role="form" id="formList" action="socket_list.vm" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3  align-left">
                                    ...
                                    <button type="button" class="btn btn-info pull-left"  data-self-js="doSearch(true)">
                            ...
                            <table id="listTable" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-xs align-center col-op-ths">
                                    	<button type="button" class="btn btn-sm  btn-white btn-op-ths" title="详情"
                                                 data-self-href="socket_detail.vm?form[customCode]=${item.customCode}">
                                            <i class="ace-icon fa fa-eye"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm  btn-white btn-op-ths" title="发送命令"
                                                 data-self-href="socket_operate.vm?form[customCode]=${item.customCode}">
