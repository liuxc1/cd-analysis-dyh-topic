								...
								<table id="listTable" class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<th class="" data-sort-col="DICTIONARY_CODE">条目编码 <i
												class="ace-icon fa fa-sort pull-right"></i>
											</th>
										
											<th class="" data-sort-col="DICTIONARY_NAME">条目名称 <i
												class="ace-icon fa fa-sort pull-right"></i>
											</th>
											<th class="" >
												所属字典 <i class="ace-icon fa fa-sort pull-right"></i>
											</th>
											<th class=""  data-sort-col="DICTIONARY_SORT">
