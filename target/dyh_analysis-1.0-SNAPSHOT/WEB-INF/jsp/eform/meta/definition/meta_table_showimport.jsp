...
<html lang="zh">
	...
	<body class="no-skin">
		...
		<script src="${ctx }/assets/js/ace-extra.js?v=20221129015223"></script>
		<script type="text/javascript" src="${ctx }/assets/components/chosen/chosen.jquery.js?v=20221129015223"></script>
