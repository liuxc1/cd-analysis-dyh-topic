...
<!-- 引入样式 -->
<link href="${ctx}/assets/components/viewer-master/dist/viewer.css" rel="stylesheet">
<style type="text/css">
	.viewer-backdrop {
...
<body class="no-skin" >
	...
	<!-- 图片放大插件 -->
	<script type="text/javascript" src="${ctx }/assets/components/viewer-master/dist/viewer-202104028.js"></script>
	<!-- vue插件 -->
