...
var vue = new Vue({
    ...
    data: {
        ...
        urls: {
            // 根据归属类型最新文件信息
            queryFileInfo: ctx + '/analysis/commonReport/getFileInfoByAscriptionType.vm',
            //列表页面
            listUrl: ctx + '/analysis/commonReport/list.vm',
            // 查询文件是否存在
    ...
    methods: {
         ...
         */
        goList:function (){
            let url=this.urls.listUrl +'?ascriptionType='+this.ascriptionType+'&menuName='+this.menuName+'&isSmallType='+isSmallType;
