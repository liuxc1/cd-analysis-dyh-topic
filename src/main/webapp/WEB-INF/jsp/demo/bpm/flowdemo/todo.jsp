				...
				<div class="main-content-inner fixed-page-header fixed-40">
					<div id="breadcrumbs" class="breadcrumbs">
						<ul class="breadcrumb">
							<li class="active">
								<h5 class="page-title">
									<i class="fa fa-file-text-o"></i> 待办工作
								</h5>
							</li>
						</ul>
						<!-- /.breadcrumb -->
							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" id="formList"
									...
									<div class="page-toolbar align-right list-toolbar">
										<div class="btn-group">
											<button data-toggle="dropdown"
												...
												aria-expanded="false">
												<i class="ace-icon fa fa-wrench"></i> 发起新工作 <i
											...
											<ul class="dropdown-menu dropdown-menu-right" style=" max-height:300px;overflow-y:auto">
												<c:forEach var="defVersion" items="${defVersions}">
													<li><a
														data-self-href="add.vm?processDefKey=${defVersion.procKey }">
									...
									<table id="listTable" class="table table-bordered table-hover">
										<thead>
											<tr>
												<th class="" data-sort-col="PRO_NAME"><i
												...
												<tr>
													...
													<td class="hidden-xs align-center col-op-ths">
														<button type="button"
															...
															data-self-href="${ctx }/flowdemo/edit.vm?id=${item.PRO_ID}&taskId=${item.TASK_ID}&status=1">
															<!-- taskkey为流程节点的编码，可以根据当前节点做一些自己的定制 -->
