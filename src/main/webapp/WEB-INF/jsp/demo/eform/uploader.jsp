...
<html>
	<head>
		...
		<%-- <link rel="stylesheet" type="text/css" href="${ctx}/assets/js/eform/upload/demo1/demo1.css"> --%>
		<!--引入JS-->
		<script type="text/javascript" src="${ctx}/assets/components/webuploader/webuploader.js"></script>
		<%-- <script src="${ctx}/assets/js/eform/upload/demo1/demo1.js"></script> --%>
		<script src="${ctx}/assets/js/eform/base64.js"></script>
		<script src="${ctx}/assets/js/eform/eform_uploader.js"></script>
		<script src="${ctx}/assets/js/eform/eform_custom2.js"></script>
		<style type="text/css">
