...
<head>
    ...
    <link href="../../assets/components/element-ui/lib/theme-chalk/index.css" rel="stylesheet" type="text/css">
    <style>
                ...
                <div class="col-xs-12">
                    <table  class="table table-bordered">
                        ...
                        <tr v-for="(item,index) in firstTable.list">
                            ...
                            <td >
                                <a @click="editPlan(item.PKID)" style="color: #ffffff">{{item.CONSULT_THEME}}</a>
                            </td>
                            <td>
...
<script type="text/javascript" src="../../assets/components/element-ui/index.js"></script>
<script>
    let vue = new Vue({
        el: '#main-container',
        data:{
