...
<script type="text/javascript" src="${ctx}/assets/custom/analysis/forecast/ensembleprediction/dataTool.min.js"></script>
...
<script type="text/javascript" src="${ctx}/assets/custom/analysis/forecast/ensembleprediction/ensemblePrediction_index.js"></script>
</body>
</html>