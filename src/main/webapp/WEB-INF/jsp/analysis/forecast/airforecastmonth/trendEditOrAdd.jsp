...
<body class="no-skin">
	...
	<%-- 	<script type="text/javascript" src="${ctx}/assets/components/jQuery-Validation-Engine/jquery.validationEngine.min.js"></script> --%>
	<!-- vue插件 -->
	...
	<script type="text/javascript" src="${ctx}/assets/custom/analysis/forecast/airforecastmonth/trendEditOrAdd.js"></script>
</body>
</html>