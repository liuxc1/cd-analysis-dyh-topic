...
<script type="text/javascript" src="${ctx}/assets/custom/components/viewer-master/dist/viewer.js"></script>

<!-- 图片上传器 -->
<%@ include file="/WEB-INF/jsp/components/common/image-upload-table.jsp" %>
<!-- 自定义js（逻辑js） -->

<script type="text/javascript" src="${ctx}/assets/custom/analysis/analysisreport/week/weekReportEdit.js"></script>
</body>
</html>