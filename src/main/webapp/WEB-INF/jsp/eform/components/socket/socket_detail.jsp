                        ...
                        <form class="form-horizontal" role="form" id="formList" action="socket_list.vm" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12  align-left">
                                    ...
                                    <button type="button" class="btn pull-right"  data-self-js="goBack()">
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-xs align-center col-op-ths">
                                        <button type="button" class="btn btn-sm  btn-white btn-op-ths" title="发送命令"
                                                 data-self-href="socket_operate.vm?form[customId]=${item.customId}&form[customCode]=${item.customCode}">
